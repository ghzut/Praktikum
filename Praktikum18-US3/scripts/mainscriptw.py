...
makeTable([tiefm45[0],tiefm45[1],tiefm45[2],Vtiefen[0]*100], r'{'+r'$\text{Messtiefe}/\si{\milli\meter}$'+r'} & {'+r'$\Delta f/\si{\hertz}$'+r'} & {'+r'$I_\text{Streu}$'+r'} & {'+r'$v_\text{mom}/\si{\centi\meter\per\second}$'+r'}' ,'tabmtief45' , ['S[table-format=2.2]' , 'S[table-format=4.0]' , 'S[table-format=5.0]' , 'S[table-format=3.0]'] ,  ["%2.2f", "%4.0f", "%5.0f", "%3.0f"])
makeTable([tiefm70[0],tiefm70[1],tiefm70[2],Vtiefen[1]*100], r'{'+r'$\text{Messtiefe}/\si{\milli\meter}$'+r'} & {'+r'$\Delta f/\si{\hertz}$'+r'} & {'+r'$I_\text{Streu}$'+r'} & {'+r'$v_\text{mom}/\si{\centi\meter\per\second}$'+r'}' ,'tabmtief70' , ['S[table-format=2.2]' , 'S[table-format=4.0]' , 'S[table-format=5.0]' , 'S[table-format=3.0]'] ,  ["%2.2f", "%4.0f", "%5.0f", "%3.0f"])

...
print(r'N_0(1-e^-yT)', unp.exp(funktionswertbei240sIn))
...
print(r'N_0(1-e^-yT)', unp.exp(funktionswertbei15sRh1))
...
print(r'N_0(1-e^-yT)', unp.exp(funktionswertbei15sRh2))
...
plt.plot(x, RhodiumErgebnisse2[0][0]*x+RhodiumErgebnisse2[0][1], label='linearer Fit der logarithmierten \n'+'Abweichungen für $t \le' + str(T1) + r'\si{\second}$')
plt.plot(x, np.log(np.exp(RhodiumErgebnisse2[0][0]*x+RhodiumErgebnisse2[0][1])+np.exp(RhodiumErgebnisse1[0][0]*x+RhodiumErgebnisse1[0][1])), label=r'N(t)')

...
Nach den kirchhoffschen Regeln folgt die DGL:
 ...
 \begin{equation}
   \overline{\omega_{1,2}} = \frac{R}{2L}i \pm \overbrace{\sqrt{\vphantom{\frac{R²}{4L²}}\smash{\underbrace
   	{\frac{1}{LC}}_{w_0^2}-\underbrace{\frac{R²}{4L²}}_{\mu^2}}}\vphantom{\sqrt{\underbrace{\frac{R²}{4L²}}_{\mu^2}}}}^{\omega_{res}}
 \end{equation}
...
\begin{equation}
  LC \ddot{U}_C + RC \dot{U}_C + U_C = A_{Antrieb} \cdot \operatorname{Re}\left( e^{i\omega t}\right)\text{.}
\end{equation}

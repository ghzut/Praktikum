...
In Tabelle \ref{tab:tabges} kann man die maximale Geschwindigkeit $v_{\text{max}}$, mit der sich der Wagen bewegt zu $\SI{51,43(2)}{\centi\meter\per\second}$ entnehmen. Es wurde eine Frequenz $f_0$ von $\SI{16594}{\hertz}$ gemessen. 

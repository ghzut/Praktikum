...
Aufgrund der Struktur eines Festkörpers ist die Ausbreitungsgeschwindigkeit $c_\text{Fe}$ in diesen im allgemeinen Richtungsabhängig.
...
Aufgrund des Energieverlustes der Schallwelle fällt der Endpeak auch bei einer fehlerfreien Probe geringfügig kleiner aus.
Fällt der Endpeak jedoch weitaus kleiner aus als es zu erwarten wäre, lässt dies auf eine Fehlstelle im Material schließen.
...
und Formel \eqref{MIST} auch die Tiefe der Fehlstelle ermittelt werden.

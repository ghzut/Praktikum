...
\begin{equation}
	\frac{L_\text{i}}{N_\text{A}} = \SI{0.323(3)}{\electronvolt}\text{.}
\end{equation}
...
\end{figure}
\begin{table}
	\caption{Die Literaturwerte der molaren Verdampfungswärme $L_\text{Lit}$  und die Werte der molaren Verdampfungswärme aus der genäherten Funktion $L_\text{App}$ mit den zugehörigen Temperaturen $T$ \cite{LWasser}.}
	\centering

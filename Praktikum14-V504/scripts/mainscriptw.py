...
makeTable([andereAngabenI[0:5],andereAngabenW[0:5],andereheiztemp, letz], r'{'+r'$I_\text{f}/\si{\ampere}$'+r'} & {'+r'$W_\text{f}/\si{\watt}$'+r'} &{'+r'$T_\text{S}/\si{\kelvin}$'+r'} & {$\phi / \si{\electronvolt}$}' ,'tabheiz' , ['S[table-format=3.1]', 'S[table-format=3.2]' , 'S[table-format=4.0]', 'S[table-format=1.2]'] ,  ["%3.1f","%3.2f", "%4.0f", "%1.2f"])

makeTable([[unp.nominal_values(lin)],[unp.std_devs(lin)],[unp.nominal_values(Heiztemp45)],[unp.std_devs(Heiztemp45)],[unp.nominal_values(dtrez)],[unp.std_devs(dtrez)]], r'\multicolumn{2}{c}{$a_\text{\SI{2.5}{\ampere}}$} & \multicolumn{2}{c}{$T_\text{\SI{2.5}{\ampere}}$}/\si{\kelvin} & \multicolumn{2}{c}{$E/\si{\electronvolt}$}', 'tabs',[r'S[table-format=1.3]',  r'@{${}\pm{}$} S[table-format=1.3]',r'S[table-format=4.0]', r'@{${}\pm{}$} S[table-format=2.0]', r' S[table-format=1.2]', r'@{${}\pm{}$} S[table-format=1.2]'], ["%1.3f", "%1.3f", "%4.0f", "%2.0f", "%1.2f", "%1.2f"])
